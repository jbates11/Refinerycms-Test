...
Refinery::Resources.configure do |config|
  ...
  # config.dragonfly_secret          = "ae06aa25a7b5c67d5e32cf2a74f8bd45f401c92a8accd788"
  # config.dragonfly_url_host        = ""
  # config.dragonfly_datastore_root_path = "/workspaces/Refinerycms-Test/public/system/refinery/resources"
